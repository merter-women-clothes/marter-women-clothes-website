  ...
  return <div className="product-page">
    ...
    <section className="product-detail">
      ...
      <div className="detail-info">
        ...
        <div className="order-actions"><a className="btn whatsapp" href={STORE.whatsappUrl} target="_blank" rel="noreferrer"><Icon name="phone"/> طلب عبر واتساب</a><a className="btn telegram" href={`https://t.me/${STORE.telegram}?text=${text}`} target="_blank" rel="noreferrer">طلب عبر تيليجرام</a></div>
